...
Betrachtet man das erste Diagramm, ist dabei zu sehen, dass ab dem Einsatz eines fünften Prozessors der Speedup gegen Null geht. Die Ursache hierfür ist zu erkennen, wenn man sich die generierten und genutzten hostfiles vor Augen führt. Als Beispiel, sie hier das generierte hostfile \textit{myhostfile15} gezeigt.\\
...
In den Graphen ist zu erkennen, dass der Speedup umso höher ist, je weniger und kleinere Rechtecke im Raster enthalten sind. Besonders beachtlich ist daher der Speedup für die Probleminstanz ohne schwarze Felder.\\
...
\(Speedup_{Alles weiß} > Speedup_{Schachbrett} > Speedup_{Alles schwarz} \)\\
Für die Effizienz gilt die entsprechende Relation.\\

Bei den Probleminstanzen für die Raster-Breite \(n=100\) ist anzumerken, dass auch die Effizienz mit Kommunikation für alle drei Instanzen so hoch ist, dass sich eine Parallelisierung lohnt (Hier wirkt sich der in Feststellung \#2 beschriebene Effekt besonders sichtbar aus). Nach Überschreiten der Rechner-Grenze wird jedoch die Effizienz \(E(p)<1\), wie in Feststellung \#1 beschrieben.\\
...
wir gehen nur bis 10.000

Max ergibt sich vor allem aus Restriktion für lokalen Festplatten-Speicher für Benutzer auf genutztem Laufwerk.
Daher wurde in der Implementierung int verwednet. Bildet bis zu long int ab. Brauchen das für errechnung der Indizes Addessierung Felder im Raster. 

Beide sind unten dargestellt:

\begin{tabular}{l|c|c|c|c|c|}
	\hline 
	long integer & Raster-Breite & Elemente im Raster & int-Max erreicht? & Größe txt-File \\ 
	\hline 
	2.147.483.647 & 10.000 & 100.000.000 & nein & 200 MB\\
	\hline 
	2.147.483.647 & 20.000 & 400.000.000 & nein & 800 MB \\
	\hline
	2.147.483.647 & 30.000 & 900.000.000 & nein &  1,8GB \\
	\hline  
	2.147.483.647 & 40.000 & 1.600.000.000 & nein & 3,2GB \\
	\hline
	2.147.483.647 & 50.000 & 2.500.000.000 & ja & 5GB \\
	\hline  
\end{tabular}\\

1,8GB war beim testen noch möglich. Vielleicht auch noch 3,2 aber Zeit zu lange beim generieren.
Damit tests durchführen hätte ewig gebraucht.\\

Beispielhaft wird in \textbf{Abbildung 14 }
n= 1000 und n=10.000. Am Beispiel: Alles Schwarz.\\
